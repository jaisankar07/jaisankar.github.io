      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
          ...
          <a
            ...
            className="flex items-center justify-center border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 px-6 py-3 rounded-lg font-medium transition-colors"
          >
